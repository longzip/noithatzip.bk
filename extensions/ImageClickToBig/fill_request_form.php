...
if(isset($_POST['submit']))
{
    ...
    if(empty($_POST['list_option'])) $list_option = json_encode(array());
    else $list_option = json_encode($_POST['list_option']);
    
     
    $insert_content['attributes'] = $list_option;
...
else
{
    ...
    else
    {
        ...
        if(!empty($temp['content'])) $default_value['content'] = $temp['content'];
        else $default_value['content'] = '';
    }
}
