...
<div class="row">
    <form class="col-xs-12" id="insert_by_link_form"  method="POST">
        <label class="" for="link_insert">Đường dẫn ảnh : </label><br />
        <input class="form-control" id="link_insert" value="" type="text" name="link_insert" /><br />
        
        <label class="" for="title">Miêu tả</label><br />
        <input class="form-control title description" id="title" value="" type="text" name="title" /><br />
