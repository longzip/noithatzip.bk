...
switch($g_page_info['page_type'])
{
    case 'home' :
    { 
        $smarty->display( CLIENT_ROOT . '/tpl/tpl/' . TEMPLATE . '/home/' . get_option('home_template') . '.tpl' );
        break;
    }
    case 'category' :
    {
        ...
        $file_executive = CLIENT_ROOT . '/tpl/tpl/' . TEMPLATE . '/category/' . $category_info['template'] . '.tpl' ;
    ...
    case 'tag' :
    {
        ...
        $smarty->assign('posts', $posts);
        $file_executive = CLIENT_ROOT . '/tpl/tpl/' . TEMPLATE . '/tag/' . $tag_info['template'] . '.tpl';
        $smarty->display( $file_executive );
    ...
    case 'post' :
    {
        ...
        $file_executive = CLIENT_ROOT . '/tpl/tpl/' . TEMPLATE . '/post/' . $post_info['template'] . '.tpl';
        $smarty->display( $file_executive );
    ...
    case 'search' :
    {
        ...
        $smarty->assign('posts', $posts);
        $file_executive = CLIENT_ROOT . '/tpl/tpl/' . TEMPLATE . '/search/default.tpl';
        $smarty->display(  $file_executive );
