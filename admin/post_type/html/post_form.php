<?php 
$default_value[$temp_post_type['name']] = htmlspecialchars($default_value[$temp_post_type['name']]);
if(isset($_POST[$temp_post_type['name']])) $_POST[$temp_post_type['name']] = htmlspecialchars($_POST[$temp_post_type['name']]);
?>
