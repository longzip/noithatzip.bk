...
$default_value[$temp_post_type['name']] = htmlspecialchars(strip_tags($_POST[$temp_post_type['name']]));


$insert_content[$temp_post_type['name']] = htmlspecialchars(strip_tags($_POST[$temp_post_type['name']]));
