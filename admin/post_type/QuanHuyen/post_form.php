<div class="new-thread-item box">
    ...
    <div class="field-content">
        ...
        <select name="<?php echo $temp_post_type['name'] ?>" class="quan_huyen-select">
             <option class="quan_huyen-noneselect" <?php if($default_value[$temp_post_type['name']] == '0') echo 'selected ' ?> value="0">-- Quận Huyện --</option>     
             <?php
                
               foreach($lists as $k => $list)
               {
                    ?>
                    <optgroup class="none quan-huyen quan-huyen-<?php echo pretty_string($k) ?>" label="<?php echo $k ?>">
                        ...
                        <?php 
                            ...
                            {
                                ?>
                                <option  <?php if($default_value[$temp_post_type['name']] == $qh) echo 'selected ';//if(isset($_GET[$temp_post_type['name']]) && ($_GET[$temp_post_type['name']] == $qh ) ) echo 'selected ' ?> value="<?php echo $qh ?>"><?php echo $qh ?></option>
                                <?php
                            }
                        ?>
