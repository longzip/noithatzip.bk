...
<select id="select_domain">
    ...
    <option value="rongbay2">Rongbay.com 2</option>
...
<form>
    ...
    <input id="start-page" type="text" placeholder="Start Page" />
    
    <input id="end-page" type="text" placeholder="End Page" />
    ...
    <input type="button" value="Lấy nội dung" id="get_content_multi_by_number" />
</form>
