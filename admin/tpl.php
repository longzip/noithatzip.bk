<?php
	...
	$g_page_content['title'] = 'Chỉnh sửa giao diện';
...
<script lang="javascript" src="<?php echo CDN_DOMAIN . '/admin/js/tpl.js?v=' . FRONT_END_VERSION  ?>"></script>
<script lang="javascript" src="<?php echo CDN_DOMAIN . '/admin/js/tpl-upload.js?v=' .FRONT_END_VERSION ?>"></script>
...
<link type="text/css" rel="stylesheet" href="<?php echo CDN_DOMAIN ?>/admin/css/tpl.css?v=<?php echo FRONT_END_VERSION ?>" />
    ...
    <div id="main-content" class="clearfix  wrap-editor ">
        <div class="" id="tpl">
            ...
            <div class="fl project-file   v-col-lg-3 v-col-md-3 v-col-sm-4 v-col-xs-5 v-col-tx-6">
                ...
                <?php 
                    $client_tpl_dir = CLIENT_ROOT . '/tpl/tpl';
                    if(file_exists($client_tpl_dir) ) //
                    {
