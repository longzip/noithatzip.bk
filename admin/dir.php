...
<div class="container">
    <h1 class="title-font">
    	<p class="fl"><a class="gallery-folder"  href="<?php echo SITE_URL ?>/media/tpl/dir.php">&nbsp;&nbsp;&nbsp;&nbsp;Thu m?c c?a b?n</a></p>
        ...
        -->
        &nbsp;&nbsp; ( <?php echo count($attachments) ?> m?c )
        
        <div id="new-dir" current_dir="" class="fr">T?o thu m?c m?i</div>
        
        <form class="fr media-search" action="" method="GET">
            <input class="text" name="s" placeholder="Tìm ki?m" value="<?php if(isset($_GET['s'])) echo $_GET['s'] ?>" />
    ...
    <div class="row fr new-gallery-upload-form" style="margin-top:40px;">
        ...
        <form id="upload-form" class="col-xs-12 uploadform" enctype="multipart/form-data" action="<?php echo SITE_URL ?>/media/tpl/upload_multi_handle.php" method="POST">
            ...
            <div class="col-xs-6" id="upload-drop-area">
                ...
                <input class="btn btn-info" type="button" value="Ch?n ?nh t? máy tính" id="virtual_select_file" /><br />
                <p style="  color: #7B7B7B;margin-top: 15px;">Ho?c kéo th? t?p vào dây</p>
            </div>
            
            <div class="col-xs-6">
                <input  id="upload_instant" class="btn btn-info none" type="submit" value="Ch?n ?nh t? máy tính" />
            </div>
