...
<form action="" method="POST">
    ...
    <textarea class="textarea" name="links"></textarea>
    ...
    <input type="text" value="" name="f_title" class="text" />
    <span class="clear"></span>
    </div>
    <span class="clear"></span>
    
    <div class="fetch-item">
    <label class="title-font">Tiêu đề SEO</label>
    <input type="text" value="title" name="f_seo_title" class="text" />
    <span class="clear"></span>
    </div>
    <span class="clear"></span>
    
    <div class="fetch-item">
    <label class="title-font">Thẻ mô tả</label>
    <input type="text" value='meta[name="description"]' name="f_seo_description" class="text" />
    <span class="clear"></span>
    </div>
    <span class="clear"></span>
    
    <div class="fetch-item">
    <label class="title-font">Thẻ keyword</label>
    <input type="text" value='meta[name="keywords"]' name="f_seo_keywords" class="text" />
    <span class="clear"></span>
    </div>
    <span class="clear"></span>
