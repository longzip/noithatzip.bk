        ...
        <div id="form_content" class="col-xs-8 col-md-10 text-left clearfix">
             ...
             <form  role="form"  action="" method="post">
                ...
                <div class="col-xs-12">
                    ...
                    <br />
                    <input class="form-control the_title" id="block_area_title" value="<?php echo $result['name'] ?>" type="text" name="block_area_title" /><br />
                    <input class="the_url fr <?php echo $global_current_row['submit_text'] ?>" placeholder="Url" id="block_area_name" value="<?php echo $result['url'] ?>" type="text" name="block_area_name" />
                    ...
                    <p class="form-group form-box">
                        ...
                        <br />
                        <textarea class="" style="width: 98%;max-width:98%;min-height:150px" id="block_area_description" name="block_area_description"><?php echo $result['description'] ?></textarea>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-box form-group ">
                        ...
                        <input class="btn btn-primary" name="submit_block_area" id="submit_block_area" type="submit" value="<?php echo $global_current_row['submit_text']?>" />
                    </div>
