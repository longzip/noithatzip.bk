...
foreach($list_dirs as $k=>$list_dir)
{
	...
	for($i=0;$i<=$k;$i++)
	{
		...
		?>
		<a class="gallery-folder" href="<?php echo SITE_URL ?>/media/tpl/upload_to_dir.php?dir=<?php echo urlencode($href) ?>">&nbsp;&nbsp;&nbsp;<?php echo $list_dir ?> &nbsp;</a>
		<?php
    ...
    <div id="inner-dir">
        ...
        foreach($dirs as $dir)
        {
        	$dir_path = urlencode(urldecode($_GET['dir']) . '/' . $dir )
        	 ?>
            <div class="dir">
            <a class="dir-inner" href="<?php echo SITE_URL ?>/media/tpl/upload_to_dir.php?dir=<?php echo $dir_path ?>">
