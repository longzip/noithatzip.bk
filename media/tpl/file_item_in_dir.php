        ...
        case 'image' :
        {
            ...
            <div real_src="<?php echo SITE_URL, '/', $real_v_attachments['url']; ?>" class="active pointer" src="<?php echo SITE_URL, '/',  $timthumb_src ?>"  >
                <?php
                    ...
                    {
                        ?>
                        <img   real_src="<?php echo SITE_URL, '/', $real_v_attachments['url']; ?>" class=" lazyload active pointer" src="<?php echo CDN_DOMAIN ?>/inc/images/loading-lazyloading.gif" data-src="<?php echo SITE_URL, '/',  $timthumb_src ?>" />
                        <?php
                    }
                    else
                    {
                        ?>
                        <img   real_src="<?php echo SITE_URL, '/', $real_v_attachments['url']; ?>" class="   active pointer" src="<?php echo SITE_URL, '/',  $timthumb_src ?>" />
                        <?php
                    }
                ?>
