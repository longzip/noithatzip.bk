...
<form id="text_form_setting" class="block_form" block_id="0">
    ...
    <div class="form-group clearfix">
        <label class="" for="name">Tag</label>
         
        <select class="form-control parameter" parameter="tag">
	...
	<div class="form-group clearfix">
		...
		<select class="form-control parameter" parameter="orderby">
            ...
            <option value="stt" <?php if($default['orderby'] == 'stt') echo 'selected' ?>>Số thứ tự</option>
    ...
    <div class="advanced none">
        ...
        <div class="form-group clearfix">
            <label class="" for="name">Chọn loại bài viết <span style="font-size: 10px;">( Khuyến cáo : Không tùy tiện chỉnh mục này )</span></label>
    		<select class="form-control parameter" parameter="post_type">
                ...
                <?php 
                    ...
                    {
                        ?>
                        <option <?php if($default['post_type'] == $list['id']) echo ' selected ' ?> value="<?php echo $list['id'] ?>"><?php echo $list['name'] ?></option>
                        <?php
                    }
                ?>
    		</select>
