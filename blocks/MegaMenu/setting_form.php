        ...
        $("body").on("click", ".add_child", function(){
            ...
            var add = '<div style="margin-left:' + margin_left + 'px" id="menu-item-' + menu_item_count + '" class="menu-item array_form" depth="' + depth + '">\
                            ...
                            <div class="inner" style="display: none;">\
                                ...
                                <div class="menu-item-item image">\
                                    <div class="form-box image-' + menu_item_count + '" id="form-image-' + menu_item_count + '">\
                            			<div class="form-field">\
                            				<input  class=" anchor-text anchor-text form-control parameter-depth-1"  parameter="image"  id="image-' + menu_item_count + '" value="" type="hidden" name="image-' + menu_item_count + '" />&nbsp;&nbsp;\
                            				<span id="image-' + menu_item_count + '_display" style="max-width: 100%;"></span>\
                                            <input type="button" value="Chọn ảnh" class="show-media-frame btn btn-info" particular="image-' + menu_item_count + '" />\
                                        </div>\
                            		</div>\
                                </div>\
                    ...
                    foreach($default as $k=>$v)
                    {
                        ...
                        <div style="margin-left:<?php echo $v['depth']*20 ?>px" id="menu-item-<?php echo $k ?>" class="menu-item array_form" depth="<?php echo $v['depth'] ?>">
                            ...
                            <div class="inner" style="display: none;">
                                ...
                                <div class="menu-item-item image">                                
                                    <div class="form-box image-<?php echo $k ?>" id="form-image-<?php echo $k ?>">
                            			<div class="form-field">
                            				<input  class=" anchor-text anchor-text form-control parameter-depth-1" parameter="image" id="image-<?php echo $k ?>" value="<?php echo $v['image'] ?>" type="hidden" name="image-<?php echo $k ?>" />&nbsp;&nbsp;
                            				<span id="image-<?php echo $k ?>_display" style="max-width: 100%;">
                                            <?php 
                                                if(!empty($v['image']))
                                                {
                                                    ?>
                                            ...
                                            <input type="button" value="Chọn ảnh" class="show-media-frame btn btn-info" particular="image-<?php echo $k ?>" />                       				
