            ...
            if($k < $count-1)
            {
                ...
                if($temporary_setting_parameter[$k+1]['depth'] == $temporary_setting_parameter[$k]['depth'])
                {
                    ...
                    <li class="<?php if(CURRENT_URL == $temporary_setting_parameter[$k]['link']) echo 'active ' ?>" >
                        ...
                        <a href="<?php echo $temporary_setting_parameter[$k]['link'] ?>">
                            <?php 
                                if(!empty($temporary_setting_parameter[$k]['image']))
                                {
                                    ?>
                                    <span class="menu-item-image">
                                        <img src="<?php echo $temporary_setting_parameter[$k]['image'] ?>"  alt="<?php echo $temporary_setting_parameter[$k]['anchor'] ?>" title="<?php echo $temporary_setting_parameter[$k]['anchor'] ?>" />
                                    </span>
                                    <?php
                                }
                            ?>
                            <span class="menu-item-text">
                                <?php echo $temporary_setting_parameter[$k]['anchor'] ?>
                            </span>
